define(function(){    
        ...
        var table = [  '<ul class="nav nav-tabs" role="tablist">',
                        ...
                        '<div class="tab-content">',
                            '<div role="tabpanel" class="tab-pane bhjj" id="param" style="display: block;">',
                                ...
                                '</div>',
                                '</div>',
                                '<div class="tab-pane active" id="option02" style="padding-top: 0px">',
                                '<div>',
                                ...
                                '</div>',
                                '</div>',
                                '<div class="tab-pane active" id="option03" style="padding-top: 0px">',
                                '<div>',
                                '<span style="color:#5D5BA8;margin-top;10px;">提示框</span>',
                                '<hr style="margin-top:10px;">',
                                '<form role="form">',
    ...
    var tableAndConfigOfPie = function(){
        var table = ['<ul class="nav nav-tabs" role="tablist">',
                    ...
                    '</div>',
                    '</div>',
                    '<div class="tab-pane active" id="option04" style="padding-top: 0px">',
                    '<div>',
                    '<span style="color:#5D5BA8;margin-top;10px;">提示框</span>',
                    '<hr style="margin-top:10px;">',
                    '<form role="form">',
