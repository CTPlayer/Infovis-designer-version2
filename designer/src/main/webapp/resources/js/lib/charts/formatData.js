        ...
        var table = [  '<ul class="nav nav-tabs" role="tablist">',
                        ...
                        '<div class="tab-content">',
                            '<div role="tabpanel" class="tab-pane bhjj" id="param" style="display: block;">',
                                ...
                                '<table>',
                                '<tr>',
                                '<td class="col-md-3">不透明</td><td><input type="range" id="backgroundOpacity" min="0" max="100" data-bind="value: backgroundOpacity, valueUpdate: \'input\'"/></td><td class="col-md-2">透明</td>',
                                '</tr>',
                                '</table>',
                                '</div>',
                                '</div>',
