                          ...
                          ' <div role="tabpanel" class="tab-pane active" id="data">',
                                ...
                                '<div role="tabpanel" class="tab-pane" id="param">',
                                    '<div class="col-xs-3">',
                                        ...
                                        '</ul>',
                                    '</div>',
                                '<div class="col-xs-9" style="height:360px;overflow:auto;" id="chartConfig">',
                                '<div class="tab-content">',
                                    '<div class="tab-pane active" id="option01">',
                                        '<div>',
                                            ...
                                            '<form role="form">',
                                                ...
                                                '<div class="form-group form-group-sm">',
                                                    ...
                                                    '<div id="cp1" class="input-group colorpicker-component">',
                                                        '<input type="text" data-bind="value: titleFontColor, valueUpdate: \'input\'" class="form-control" />',
                                    ...
                                    '<div class="tab-pane" id="option04">',
                                            '<div>',
                                                '<span style="color:#5D5BA8;margin-top;10px;">图表</span>',
                                                '<hr style="margin-top:10px;">',
                                                '<form role="form">',
                                                    '<div class="form-group form-group-sm">',
                                                        '<label >柱颜色&nbsp;&nbsp;</label>',
